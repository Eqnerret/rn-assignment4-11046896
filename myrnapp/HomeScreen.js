...
const HomeScreen = () => {
  ...
  const jobCards = [
    ...
    { id: '7', title: 'UI/UX Designer', company: 'Apple', salary: '$95,000/y', location: 'San Francisco, US', icon: require('./assets/Apple.png') },
    { id: '8', title: 'Backend Developer', company: 'Microsoft', salary: '$105,000/y', location: 'Redmond, US', icon: require('./assets/microsoft.png') },
    { id: '9', title: 'Full Stack Developer', company: 'Netflix', salary: '$130,000/y', location: 'Los Gatos, US', icon: require('./assets/netflix.png') },
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Image source={require('./assets/reiss.jpg')} style={styles.profilePic} />
      </View>
